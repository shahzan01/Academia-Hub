        ...
        <div className="flex flex-col md:mx-20 gap-4">
          ...
          <div className="border rounded-lg p-4  transform transition-transform hover:shadow-lg">
            ...
            <div id="faq1" className="hidden mt-2 text-gray-700">
              AcademiaHub is a fully functional ed-tech platform designed to
          ...
          <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
            ...
            >
              <span>
                Is AcademiaHub free to use, or are there subscription plans?
              </span>
              <svg
                id="arrow2"
                className="h-6 v-6 arrow-icon transform transition-transform"
            ...
            <div id="faq2" className="hidden mt-2 text-gray-700">
              AcademiaHub offers various plans, including free access with
              limited features and premium subscription plans with additional
              benefits. Users can choose a plan that suits their needs and
          ...
          <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
            ...
            >
              <span>Can I customize my profile on AcademiaHub?</span>
              <svg
                id="arrow3"
                className="h-6 v-6 arrow-icon transform transition-transform"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div id="faq3" className="hidden mt-2 text-gray-700">
              Yes, users can customize their profiles on AcademiaHub. After
          ...
          <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
            ...
            >
              <span>How can I create educational content on AcademiaHub?</span>
              <svg
                id="arrow4"
                className="h-6 v-6 arrow-icon transform transition-transform"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div id="faq4" className="hidden mt-2 text-gray-700">
              As an instructor, you can create educational content on
              AcademiaHub by accessing the content creation tools available on
              the platform. These tools allow you to upload course materials,
              videos, quizzes, and other educational resources to share with
              learners.
            </div>
          </div>
        </div>
