          ...
          <TitleWrapper className="text-center">
            <PolicyWrapper className="terms">
              <Section className="text-left">
                ...
                <Paragraph>
                  Welcome to Academia Hub. These terms and conditions outline
                  the rules and regulations for the use of Academia Hub's
                  Website, located at www.AcademiaHub.com.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  Unless otherwise stated, Academia Hub and/or its licensors own
                  the intellectual property rights for all material on Academia
                  Hub . All intellectual property rights are reserved.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Use of Our Platform</Heading2>
                <Paragraph>
                  By using Academia Hub, you agree to abide by the following
                ...
                <SubSection>
                  ...
                  <Paragraph>
                    ...
                    with or disrupt the operation of the platform or the servers
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  you hold in the content you submit to the platform. By
                  submitting, posting, or displaying content on or through the
                  platform, you grant Academia Hub a worldwide, non-exclusive,
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  You agree to indemnify and hold Academia Hub and its
                  ...
                  the platform, or any willful misconduct on your part.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Modifications to the Service</Heading2>
                <Paragraph>
                  Academia Hub reserves the right to modify or discontinue,
                  temporarily or permanently, the platform or any part of it
                  with or without notice. You agree that Academia Hub shall not
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  Academia Hub may terminate or suspend access to the platform
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  law provisions. Our failure to enforce any right or provision
                  of these terms will not be considered a waiver of those
                  rights. If any provision of these terms is held to be invalid
                  or unenforceable by a court, the remaining provisions of these
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  <br />
                  please contact us at: Email: support@AcademiaHub.com
                </Paragraph>
              </Section>
            </PolicyWrapper>
          </TitleWrapper>
