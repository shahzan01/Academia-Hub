          ...
          <TitleWrapper className="text-center">
            <PolicyWrapper className="privacy">
              <Section className="text-left">
                ...
                <Paragraph>
                  Welcome to Academia Hub. We are committed to protecting your
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  as name, email address, contact information, and payment
                  information. We collect personal information when you register
                  for our services, create or consume educational content, rate
                  content, participate in activities on the platform, or
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  email us at:{" "}
                  <a href="mailto:support@AcademiaHub.com">
